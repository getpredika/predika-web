...
export default function RegisterPage() {
    ...
    return (
        <>
            <SEOHelmet
                title="Enskripsyon - Predika"
                description="Enskri pou jwenn aksè nan zouti koreksyon tèks Kreyòl Predika a. Kreye yon kont fasil e rapid."
                keywords="Enskripsyon, Predika, Koreksyon Tèks Kreyòl, Kreye Kont, Zouti Koreksyon"
                imageUrl="https://predika.app/public/predika-logo.png"
                url="https://predika.app/anregistre"
            />
