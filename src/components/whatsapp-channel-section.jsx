...
export default function WhatsAppChannelSection() {
  ...
  {/* container is already centered, add mx-auto for safety */}
  <div className="container mx-auto px-4 md:px-6">
    <motion.div
      ref={ref}
      className="grid lg:grid-cols-2 gap-8 items-center justify-items-center text-center lg:text-left"
    ...
    >
      ...
      >
        <div className="text-center mb-4">
          ...
          <h3 className="text-lg font-semibold text-[#2d2d5f]">Kanal Predika</h3>
