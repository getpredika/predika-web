...
export default function DictionarySecondaryHeader({ searchTerm, onSearchChange }) {
  return (
    <header className="w-full py-12 md:py-24 lg:py-32 relative bg-white">
      <div
