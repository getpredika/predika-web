...
export function Orb({
    colors = ["#CADCFC", "#A0B9D1"], // Default to Predika brand colors (secondary, primary)
    colorsRef,
    resizeDebounce = 100,
    seed,
    agentState = null,
...
function Scene({
    ...
    useEffect(() => {
        const apply = () => {
            ...
            const uInverted = circleRef.current.material.uniforms.uInverted
            if (!uInverted) return
