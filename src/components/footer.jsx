                ...
                <div className="grid grid-cols-1 gap-14 md:grid-cols-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2">
                            <li><Link href="#" className="text-gray-500 hover:text-[#40c4a7] text-sm">Karakteristik</Link></li>
                            <li><Link href="#" className="text-gray-500 hover:text-[#40c4a7] text-sm">Atik</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2">
                            <li><Link href="#" className="text-gray-500 hover:text-[#40c4a7] text-sm">Koreksyon Tèks</Link></li>
                            <li><Link href="#" className="text-gray-500 hover:text-[#40c4a7] text-sm">Zouti Aprantisaj</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2">
                            <li><Link href="#" className="text-gray-500 hover:text-[#40c4a7] text-sm">Rapòte yon erè</Link></li>
                            <li><Link href="#" className="text-gray-500 hover:text-[#40c4a7] text-sm">Kontakte nou</Link></li>
                        </ul>
